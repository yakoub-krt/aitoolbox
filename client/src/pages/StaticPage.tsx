...
const content: Record<string, { eyebrow: string; title: string; body: React.ReactNode }> = {
  ...
  "/privacy": { eyebrow: "الخصوصية", title: "سياسة خصوصية مبسطة", body: <><p>نستخدم بيانات الاستخدام الأساسية لتحسين أداء الموقع وفهم الصفحات المفيدة. لا نبيع بياناتك الشخصية، ولا نطلب منك رفع ملفات حساسة عبر المدونة.</p><h2>الاشتراك بالبريد</h2><p>عند اشتراكك، نخزّن بريدك الإلكتروني وحالة موافقتك فقط لإرسال تحديثات AIToolBox. يمكنك إلغاء الاشتراك في أي وقت من الرابط الموجود في كل رسالة، وسيتوقف الإرسال إليك تلقائياً.</p><h2>رسائل التواصل</h2><p>عند إرسال رسالة، نخزّن الاسم والبريد الإلكتروني ونص الرسالة بهدف الرد والمتابعة. يمكنك طلب حذف رسالتك عبر صفحة التواصل.</p><h2>روابط وخدمات خارجية</h2><p>قد تقودك بعض الروابط إلى مواقع أدوات خارجية لها سياسات خصوصية خاصة بها. نوصي دائماً بمراجعة سياسة الأداة قبل إنشاء حساب أو رفع بيانات.</p></> },
